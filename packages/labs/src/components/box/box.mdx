...
<ReactCodeExample name="BoxBasicExample" />
...
<ReactCodeExample name="BoxAsChildExample" />
## Layout props
...
<ReactExample name="BoxPaddingExample" />
### Margin

<ReactExample name="BoxMarginExample" />
### Object Card

A practical example demonstrating how to compose a card layout using Box with multiple layout props working together.

<ReactExample name="BoxObjectCardExample" />
## Props interface

<InterfaceTable name="BoxProps" />