...
export class EnumTable extends React.PureComponent<IEnumTableProps & IDocumentationContext> {
    public static displayName = "Docs2.EnumTable";

    public render() {
        const { data, renderBlock } = this.props;
        return (
        ...
        return (
            <tr key={name}>
                ...
                <td className="docs-prop-details">
                    ...
                    <div className="docs-prop-description">{this.props.renderBlock(entry.documentation)}</div>
