...
import { Button, IToastProps, IToasterProps, Intent, Position, Switch, Toaster } from "@blueprint/core";
import * as classNames from "classnames";
import * as React from "react";

import { getTheme } from "../components/styleguide";
...
export class ToastExample extends BaseExample<IToasterProps> {
    ...
    private addToast(toast: IToastProps) {
        // NOTE: Object.assign exists in the docs project cuz it's ES6
        this.toaster.show(Object.assign({ className: getTheme(), timeout: 3000 }, toast));
    }
