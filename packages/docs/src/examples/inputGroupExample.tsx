...
import { Button, Classes, InputGroup, Intent, Menu, MenuItem, Popover, Position, Switch, Tag, Tooltip } from "@blueprint/core";
import * as React from "react";

import BaseExample, { handleBooleanChange, handleStringChange } from "./baseExample";

interface IInputGroupExampleState {
    disabled?: boolean;
    filterValue?: string;
