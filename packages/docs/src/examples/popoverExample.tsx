...
import {
    ...
    TimePicker,
    TimePickerPrecision,
} from "@blueprint/datetime";
import * as classNames from "classnames";
import * as React from "react";

import BaseExample, { handleBooleanChange, handleNumberChange } from "./baseExample";
...
export class PopoverExample extends BaseExample<IPopoverExampleState> {
            ...
            [
                <label className="pt-label" key="content">
                    ...
                    <div className="pt-select">
                        <select value={this.state.contentIndex.toString()} onChange={this.handleContentIndexChange}>
                            <option value="0">Text</option>
                            <option value="1">Input</option>
                            <option value="2">Slider</option>
                            <option value="3">DatePicker</option>
                            <option value="4">DateRangePicker</option>
                            <option value="5">TimePicker</option>
                            <option value="6">Menu</option>
                            <option value="7">Popover Example</option>
                        </select>
                    </div>
                </label>,
                <Switch
    ...
    private getContents(index: number) {
        return [
            ...
            <DatePicker/>,
            <DateRangePicker/>,
            <TimePicker precision={TimePickerPrecision.SECOND}/>,
            <Menu>
