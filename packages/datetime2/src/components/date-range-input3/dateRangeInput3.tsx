...
export class DateRangeInput3 extends DateFnsLocalizedComponent<DateRangeInput3Props, DateRangeInput3State> {
    ...
    private getIsOpenValueWhenDateChanges(nextSelectedStart: Date, nextSelectedEnd: Date) {
        ...
        // Close the popover on date selection if TimePicker is not shown.
        ...
        const selectedStart: Date | null = this.state.selectedStart;
        const selectedEnd: Date | null = this.state.selectedEnd;
