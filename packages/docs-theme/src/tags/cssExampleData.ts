...
export const cssExampleData: Record<string, CssExampleData> = {
  ...
  the world to solve problems we hadn't even dreamed of back then.
        ...
        modifiers: [
            ...
            {
                name: ".bp6-monospace-text",
                documentation: "Use a monospace font (ideal for code).",
            },
            {
            ...
            {
                name: ".bp6-text-large",
                documentation: "Use a larger font size.",
            },
            {
                name: ".bp6-text-small",
                documentation: "Use a smaller font size.",
            },
            {
                name: ".bp6-text-muted",
                documentation:
  ...
  <p>
    ...
    transform the organization and turn data into a competitive advantage.
        ...
        modifiers: [
            {
                name: ".bp6-text-large",
                documentation: "Use larger font size.",
            },
        ],
    },
  ...
  <h6 class="bp6-heading {{.modifier}}">H6 heading</h6>
        ...
        modifiers: [
            {
                name: ".bp6-text-muted",
                documentation: "Change text color to a gentler gray.",
            },
        ],
    },
    ...
    <ul class="{{.modifier}}">
      ...
      <li>Item the fifth</li>
        ...
        modifiers: [
            {
                name: ".bp6-list",
                documentation: "Add a little spacing between items for readability.",
            },
            {
...
<p class="bp6-rtl">
  ...
  <button type="button" class="bp6-button bp6-icon-add {{.modifier}}" tabindex="-1">Submit</button>
        ...
        modifiers: [
            {
                name: ".bp6-skeleton",
                documentation: "Render this element as a skeleton, an outline of its true self.",
            },
        ],
    },
};
