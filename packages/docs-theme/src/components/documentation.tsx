...
export interface DocumentationProps extends Props {
    ...
    /**
     * Props registry data generated by react-docgen-typescript.
     * Used to render `<InterfaceTable>` elements in MDX content.
     */
    propsRegistry?: Record<string, any>;
...
export class Documentation extends PureComponent<DocumentationProps, DocumentationState> {
    ...
    private getDocumentationContextApi(): DocumentationContextApi {
        ...
        return {
            getDocsData: () => docs,
            getPropsRegistry: () => this.props.propsRegistry,
