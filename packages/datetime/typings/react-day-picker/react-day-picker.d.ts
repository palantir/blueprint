...
declare namespace ReactDayPicker {
    ...
    interface Props extends React.Props<DayPicker>{
        ...
        onDayClick?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onDayKeyDown?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onDayMouseEnter?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onDayMouseLeave?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onDayTouchEnd?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onDayTouchStart?: (e: React.SyntheticEvent<HTMLElement>, day: Date, modifiers: DayModifiers) => any;
        onMonthChange?: (month: Date) => any;
        onCaptionClick?: (e: React.SyntheticEvent<HTMLElement>, month: Date) => any;
        className?: string;
