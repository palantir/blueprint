...
import { type DateFormatProps, type DateRange, Months, TimePrecision } from "../../src";
...
describe("<DateRangeInput>", () => {
    it("renders with two InputGroup children", () => {
        render(<DateRangeInput {...DATE_FORMAT} />);
    ...
    it("inner DateRangePicker receives all supported props", async () => {
        render(<DateRangeInput {...DATE_FORMAT} locale="uk" contiguousCalendarMonths={false} />);

        // Open the popover to access the DateRangePicker
        await userEvent.click(getStartInputElement());

        // Verify locale prop: UK locale uses different date format/calendar
        // Verify contiguousCalendarMonths={false}: should see separate navigation buttons for each month
    ...
    describe("timePrecision prop", () => {
        it("<TimePicker /> should not lose focus on increment/decrement with up/down arrows", async () => {
            ...
            // DateRangeInput renders two TimePicker components, we only care about testing one of them
    ...
    describe("startInputProps and endInputProps", () => {
        ...
        describe("startInputProps", () => {
            it("allows custom placeholder text", () => {
                ...
                render(<DateRangeInput {...DATE_FORMAT} startInputProps={{ placeholder }} />);
            ...
            it("supports custom style", () => {
                ...
                render(<DateRangeInput {...DATE_FORMAT} startInputProps={{ style }} />);
            ...
            it("calls onChange when the value is changed", async () => {
                ...
                render(<DateRangeInput {...DATE_FORMAT} startInputProps={{ onChange }} />);
        ...
        describe("endInputProps", () => {
            it("allows custom placeholder text", () => {
                ...
                render(<DateRangeInput {...DATE_FORMAT} endInputProps={{ placeholder }} />);
            ...
            it("supports custom style", () => {
                const style = { background: "yellow" };
                render(<DateRangeInput {...DATE_FORMAT} endInputProps={{ style }} />);
            ...
            it("calls onChange when the value is changed", async () => {
                const onChange = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} onChange={onChange} popoverProps={{ usePortal: false }} />);
            ...
            it("calls onFocus when the input is focused", async () => {
                const onFocus = sinon.spy();
                render(
                    <DateRangeInput {...DATE_FORMAT} endInputProps={{ onFocus }} popoverProps={{ usePortal: false }} />,
                );
            ...
            it("calls onBlur when the input is blurred", async () => {
                const onBlur = sinon.spy();
                render(
                    <DateRangeInput {...DATE_FORMAT} endInputProps={{ onBlur }} popoverProps={{ usePortal: false }} />,
                );
    ...
    describe("placeholder text", () => {
        it("shows proper placeholder text when empty inputs are focused and unfocused", async () => {
            ...
            render(<DateRangeInput {...DATE_FORMAT} minDate={MIN_DATE} maxDate={MAX_DATE} />);
            const startInput = getStartInputElement();
            const endInput = getEndInputElement();
        ...
        it("updates placeholder text properly when format changes", async () => {
            ...
            const MIN_DATE = new Date(2022, Months.JANUARY, 1);
            const MAX_DATE = new Date(2022, Months.JANUARY, 31);
            render(<DateRangeInput {...FORMAT} minDate={MIN_DATE} maxDate={MAX_DATE} />);
            const startInput = getStartInputElement();
            const endInput = getEndInputElement();
    ...
    it("inputs disable and popover doesn't open if disabled=true", async () => {
        const { container } = render(
            <DateRangeInput {...DATE_FORMAT} disabled={true} popoverProps={{ usePortal: false }} />,
        );
        const startInput = getStartInputElement();
        const endInput = getEndInputElement();
    ...
    it("accepts contiguousCalendarMonths prop and passes it to the date range picker", async () => {
        render(<DateRangeInput contiguousCalendarMonths={false} />);
    ...
    it("accepts singleMonthOnly prop and passes it to the date range picker", async () => {
        render(<DateRangeInput singleMonthOnly={true} />);
    ...
    it("accepts shortcuts prop and passes it to the date range picker", async () => {
        render(<DateRangeInput shortcuts={false} />);
    ...
    it("should update the selectedShortcutIndex state when clicking on a shortcut", async () => {
        render(<DateRangeInput closeOnSelection={false} />);
    ...
    describe("popoverProps", () => {
        ...
        it("ignores autoFocus, enforceFocus, and content in custom popoverProps", async () => {
            ...
            render(<DateRangeInput {...DATE_FORMAT} popoverProps={popoverProps} />);
            const startInput = getStartInputElement();
    ...
    describe("when uncontrolled", () => {
        it("Shows empty fields when defaultValue is [null, null]", () => {
            render(<DateRangeInput {...DATE_FORMAT} defaultValue={[null, null]} />);
        ...
        it("Shows empty start field and formatted date in end field when defaultValue is [null, <date>]", () => {
            render(<DateRangeInput {...DATE_FORMAT} defaultValue={[null, END_DATE]} />);
        ...
        it("Shows formatted dates in both fields when defaultValue is [<date1>, <date2>]", () => {
            render(<DateRangeInput {...DATE_FORMAT} defaultValue={[START_DATE, END_DATE]} />);
        ...
        it("Pressing Enter saves the inputted date and closes the popover", async () => {
            const { container } = render(<DateRangeInput {...DATE_FORMAT} popoverProps={{ usePortal: false }} />);
            const startInput = getStartInputElement();
            const endInput = getEndInputElement();
        ...
        it("Typing a valid start or end date invokes onChange with the new date range and updates the input fields", async () => {
            const onChange = sinon.spy();
            render(<DateRangeInput {...DATE_FORMAT} onChange={onChange} />);
            const startInput = getStartInputElement();
            const endInput = getEndInputElement();
        ...
        describe("Typing an invalid date", () => {
            it("shows the error message on blur", async () => {
                render(<DateRangeInput {...DATE_FORMAT} invalidDateMessage={INVALID_MESSAGE} />);
                const startInput = getStartInputElement();
                const endInput = getEndInputElement();
            ...
            it("calls onError on blur with Date(undefined) in place of the invalid date", async () => {
                const onError = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} invalidDateMessage={INVALID_MESSAGE} onError={onError} />);
                const startInput = getStartInputElement();
                const endInput = getEndInputElement();
            ...
            it("does NOT call onChange before OR after blur", async () => {
                const onChange = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} invalidDateMessage={INVALID_MESSAGE} onChange={onChange} />);
                const startInput = getStartInputElement();
                const endInput = getEndInputElement();
        ...
        describe("Typing an overlapping date", () => {
            ...
            describe("in the end field", () => {
                ...
                it("does NOT call onChange before OR after blur", async () => {
                    ...
                    await userEvent.keyboard(OVERLAPPING_END_STR);
                    await userEvent.tab();
        ...
        describe("Arrow key navigation", () => {
            // NOTE: Tests in this suite use fireEvent.focus() instead of userEvent to control text selection state.
            // Arrow key date navigation only works when text is selected, so we need precise focus control.
            it("Pressing an arrow key has no effect when the input is not fully selected", async () => {
                const onChange = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} onChange={onChange} defaultValue={DATE_RANGE} />);
            ...
            it("Will choose a reasonable end date when only the start is selected", async () => {
                const onChange = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} onChange={onChange} defaultValue={[START_DATE, null]} />);
                const endInput = getEndInputElement();
            ...
            it("Will choose a reasonable start date when only the end is selected", async () => {
                const onChange = sinon.spy();
                render(<DateRangeInput {...DATE_FORMAT} onChange={onChange} defaultValue={[null, END_DATE]} />);
                const startInput = getStartInputElement();
    ...
    describe("when controlled", () => {
        ...
        it(`Clearing only the start input (e.g.) invokes onChange with [null, <endDate>], doesn't clear the\
            ...
            expect(getDayElement(START_DAY).hasClass(ReactDayPickerClasses.RDP_DAY_SELECTED)).to.be.true;
        ...
        it("Hovering and clicking on end date shows the new date in input, not a previously selected date", async () => {
            ...
            // hover over Dec 1
            await userEvent.hover(getDayElementRTL(1));
            ...
            // hover over Dec 2
            await userEvent.hover(getDayElementRTL(2));
        ...
        describe("localization", () => {
            describe("with formatDate & parseDate undefined", () => {
                it("formats date strings with provided Locale object", () => {
                    render(<DateRangeInput dateFnsFormat="PPP" locale={esLocale} value={DATE_RANGE_2} />);
                ...
                it.skip("formats date strings with async-loaded locale corresponding to provided locale code", async () => {
                    render(<DateRangeInput dateFnsFormat="PPP" locale="es" value={DATE_RANGE_2} />);
                    await waitFor(() => {
                        expect(getStartInputElement().value).to.equal(START_STR_2_ES_LOCALE);
                        expect(getEndInputElement().value).to.equal(END_STR_2_ES_LOCALE);
                    });
    ...
    function wrap(dateRangeInput: React.JSX.Element) {
        ...
        return {
            getDayElement: (dayNumber = 1, fromLeftMonth = true) => {
                ...
                const dayElements = monthElement.find(`.${ReactDayPickerClasses.RDP_DAY}`);
                return dayElements
                    .filterWhere(
                        d => d.text() === dayNumber.toString() && !d.hasClass(ReactDayPickerClasses.RDP_DAY_OUTSIDE),
                    )
                    .hostNodes();
            },
            root: wrapper,
