...
<ReactExample name="DatePickerExample" />
## Usage
...
<InterfaceTable name="DatePickerProps" />
## Shortcuts
...
<InterfaceTable name="DatePickerShortcut" />
## Modifiers
...
<ReactExample name="DatePickerModifierExample" />
...
<ReactExample name="DatePickerLocalizedExample" />