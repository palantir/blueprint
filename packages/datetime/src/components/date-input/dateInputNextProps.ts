...
import type { DatetimePopoverNextProps } from "../../common/datetimePopoverNextProps";
...
export interface DateInputNextProps
     ...
     *
     * Note that `inputProps.tagName` will override `popoverNextProps.targetTagName`.
     */
