...
import { AbstractPureComponent, Divider, HTMLSelect, Icon, IOptionProps } from "@blueprintjs/core";
...
export class DatePickerCaption extends AbstractPureComponent<IDatePickerCaptionProps, IDatePickerCaptionState> {
