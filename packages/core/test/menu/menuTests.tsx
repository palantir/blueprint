...
import { shallowTest } from "@blueprintjs/test-commons";

import { Classes, H6, Menu, MenuDivider, MenuItem } from "../../src";

describe("<MenuDivider>", () => {
    it("React renders MenuDivider", () => {
        using shallow = shallowTest(<MenuDivider />);
        const divider = shallow.wrapper;
    ...
    it("React renders MenuDivider with title", () => {
        using shallow = shallowTest(<MenuDivider title="Subject" />);
        const divider = shallow.wrapper;
