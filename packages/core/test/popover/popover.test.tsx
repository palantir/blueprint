...
import { afterAll as after, afterEach, assert, beforeAll as before, beforeEach, describe, test as it } from "vitest";
...
describe("<Popover>", () => {
    ...
    describe("focus management when shouldReturnFocusOnClose={true}", () => {
        ...
        it("moves focus to overlay when opened", () =>
    ...
    describe("in controlled mode", () => {
        ...
        describe("onInteraction()", () => {
            ...
            it("is invoked with `false` when open modal popover backdrop is clicked", () => {
                ...
                dispatchVitestMouseEvent(document.getElementsByClassName("test-hook")[0], "mousedown");
    ...
    describe("in uncontrolled mode", () => {
        ...
        it.skip("HOVER_TARGET_ONLY works properly", async () => {
            wrapper = renderPopover({
                interactionKind: "hover-target",
                usePortal: true,
            })
        ...
        it.skip("inline HOVER_TARGET_ONLY works properly when openOnTargetFocus={false}", async () => {
            wrapper = renderPopover({
                interactionKind: "hover-target",
                openOnTargetFocus: false,
                usePortal: false,
    ...
    describe("clicking on target", () => {
        ...
        it("does not close a HOVER interaction popover", async () => {
            ...
            dispatchVitestMouseEvent(wrapper!.targetElement);
