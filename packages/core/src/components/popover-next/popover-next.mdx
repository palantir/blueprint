...
<ReactExample name="PopoverNextExample" />
## Usage
...
<InterfaceTable name="PopoverNextProps" />
## Concepts
...
- The simplest way to specify a target is via `children`. Provide a single React child to
  `<PopoverNext>` and the component will render that child wrapped in a `bp5-popover-target` HTML element.
...
<ReactExample name="PopoverNextPlacementExample" />
#### Automatic placement
...
<div className="bp5-callout bp5-intent-warning bp5-icon-warning-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Auto placement requires autoPlacement or flip middleware</h5>
...
<ReactExample name="PopoverNextInteractionKindExample" />
...
<ReactExample name="PopoverNextPortalExample" />
## Style

### Dark theme

**PopoverNext** automatically detects whether its trigger is nested inside a `.bp5-dark` container and applies the
...
<ReactExample name="PopoverNextSizingExample" />
### Arrow control
...
<ReactExample name="PopoverNextMinimalExample" />
