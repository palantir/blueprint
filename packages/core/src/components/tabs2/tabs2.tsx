...
export class Tabs2 extends AbstractComponent<ITabs2Props, ITabs2State> {
    ...
    public componentDidUpdate(prevProps: ITabs2Props, prevState: ITabs2State) {
        if (this.state.selectedTabId !== prevState.selectedTabId) {
            ...
            if (!Utils.arraysEqual(this.getTabChildren(prevProps.children), this.getTabChildren(), Utils.shallowCompareKeys)) {
                this.moveSelectionIndicator();
            }
        }
    }
    ...
    private getTabChildren(child: React.Children = this.props.children) {
