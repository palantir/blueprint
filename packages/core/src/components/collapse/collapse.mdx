...
<ReactCodeExample name="CollapseBasicExample" />
...
<ReactCodeExample name="CollapseMountedExample" />
## Interactive Playground

<ReactExample name="CollapsePlaygroundExample" />
## Props interface

<InterfaceTable name="CollapseProps" />