...
<InterfaceTable name="DefaultIconProps" />
## DOM attributes
...
<ReactExample name="IconGeneratedComponentExample" />
<InterfaceTable name="DefaultSVGIconProps" />
## CSS API
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Non-standard sizes</h5>
