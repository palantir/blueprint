...
<ReactCodeExample name="DividerBasicExample" />
## Compact
...
<ReactCodeExample name="DividerVerticalExample" />
## Interactive Playground

<ReactExample name="DividerPlaygroundExample" />
## Props interface

<InterfaceTable name="DividerProps" />