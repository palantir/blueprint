...
<ReactExample name="HotkeysTargetExample" />
Try modifier key combinations too.

<ReactExample name="HotkeyModifierExample" />
## Usage
...
<InterfaceTable name="HotkeysTargetProps" />
<InterfaceTable name="UseHotkeysOptions" />
## Hotkey configuration

<InterfaceTable name="HotkeyConfig" />