...
import { ClassesNext, mergeRefs } from "../../common";
import { DISPLAYNAME_NEXT_PREFIX, type Props } from "../../common/props";
 ...
 */
export const TextNext: React.FC<TextProps> = forwardRef<HTMLElement, TextProps>(
        ...
        return createElement(
            tagName,
            {
                ...
                className: classNames(
                    ClassesNext.TEXT,
                    {
                        [ClassesNext.TEXT_OVERFLOW_ELLIPSIS]: ellipsize,
                    },
                    className,
                ),
                ref: textRef,
...
TextNext.displayName = `${DISPLAYNAME_NEXT_PREFIX}.Text`;
