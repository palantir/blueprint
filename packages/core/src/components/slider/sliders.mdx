...
<ReactExample name="SliderExample" />
<InterfaceTable name="SliderProps" />
## Range slider
...
<ReactExample name="RangeSliderExample" />
<InterfaceTable name="RangeSliderProps" />
## Multi slider
...
<ReactExample name="MultiSliderExample" />
<InterfaceTable name="MultiSliderProps" />
### Handle
...
<InterfaceTable name="HandleProps" />