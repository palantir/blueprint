...
<div className="bp5-callout bp5-intent-success bp5-icon-comparison bp5-callout-has-body-content">
    <h5 className="bp5-heading">Control group vs. input group</h5>
...
<ReactExample name="ControlGroupExample" />
## Flex layout
...
<InterfaceTable name="ControlGroupProps" />