...
<ReactCodeExample name="ButtonGroupBasicExample" />
## Intent
...
<ReactCodeExample name="ButtonGroupIntentExample" />
## Variant

Use the `variant` prop to change the visual style of button child elements within the group.

<ReactCodeExample name="ButtonGroupVariantExample" />
...
<ReactCodeExample name="ButtonGroupOutlinedMinimalExample" />
## Size

The `size` prop can be used to control the size of all child buttons within the button group.

<ReactCodeExample name="ButtonGroupSizeExample" />
## Flex layout
...
<ReactCodeExample name="ButtonGroupFlexExample" />
## Vertical layout
...
<ReactCodeExample name="ButtonGroupVerticalExample" />
## Usage with popovers

**Button** elements inside a **ButtonGroup** can be wrapped with a
[**Popover**](#core/components/popover) to create complex toolbars.

<ReactExample name="ButtonGroupPopoverExample" />
## Interactive Playground

<ReactExample name="ButtonGroupPlaygroundExample" />
## Props interface
