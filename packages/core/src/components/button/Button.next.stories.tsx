...
/**
 * Use the `loading` prop to make the button show a spinner.
 */
export const LoadingExample: Story = {
    ...
    render: args => (
        <Flex flexDirection="column" gap={2} className={"bp-next"}>
            <Button {...args} intent="primary" loading={true} text="Loading" />
            <Button {...args} intent="success" loading={true} text="Loading" />
            <Button {...args} intent="warning" loading={true} text="Loading" />
            <Button {...args} intent="danger" loading={true} text="Loading" />
            <Button {...args} loading={true} text="Loading" />
            <Button {...args} loading={false} text="Not loading" />
        </Flex>
    ),
};
