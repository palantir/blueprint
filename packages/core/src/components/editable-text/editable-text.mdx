...
<ReactCodeExample name="EditableTextBasicExample" />
<div className="bp5-callout bp5-intent-danger bp5-icon-error bp5-callout-has-body-content">
    <h5 className="bp5-heading">Centering EditableText</h5>
...
<kbd>Enter</kbd>. Pressing the <kbd>Enter</kbd> key by itself moves the cursor to the next line. This behavior can be
inverted with the `confirmOnEnterKey` prop.

<ReactCodeExample name="EditableTextMultilineExample" />
## Intent
...
<ReactCodeExample name="EditableTextIntentExample" />
## Select text on focus

Enable `selectAllOnFocus` to automatically select all text when the input is focused.

<ReactCodeExample name="EditableTextSelectExample" />
## Interactive Playground

<ReactExample name="EditableTextPlaygroundExample" />
## Props interface

<InterfaceTable name="EditableTextProps" />