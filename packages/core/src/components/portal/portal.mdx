...
<div className="bp5-callout bp5-intent-warning bp5-icon-move bp5-callout-has-body-content">
    <h5 className="bp5-heading">A note about responsive layouts</h5>
...
<InterfaceTable name="PortalProps" />
