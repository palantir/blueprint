...
<ReactExample name="SwitchCardExample" />
## Checkbox card
...
<ReactExample name="CheckboxCardExample" />
## Radio card
...
<ReactExample name="RadioCardGroupExample" />
## Props interface

<InterfaceTable name="ControlCardProps" />
## Combining with CardList

Control cards work just like regular cards inside a [**CardList**](#core/components/card-list).

<ReactExample name="ControlCardListExample" />