...
<ReactExample name="ToastExample" />
## Usage
...
<InterfaceTable name="ToastProps" />
### OverlayToaster
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Working with multiple toasters</h5>
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Toaster focus</h5>
...
<InterfaceTable name="OverlayToasterProps" />
## Static usage
...
<InterfaceTable name="OverlayToasterCreateOptions" />
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Beware of memory leaks</h5>
...
<ReactExample name="ToastCreateAsyncExample" />
