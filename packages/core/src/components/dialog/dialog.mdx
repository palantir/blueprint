...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Terminology note</h5>
...
<ReactExample name="DialogExample" />
## Usage
...
<InterfaceTable name="DialogProps" />
### Dialog body props
...
<InterfaceTable name="DialogBodyProps" />
### Dialog footer props
...
<InterfaceTable name="DialogFooterProps" />
## Multistep dialog

<ReactExample name="MultistepDialogExample" />
...
<InterfaceTable name="MultistepDialogProps" />
### DialogStep
...
<InterfaceTable name="DialogStepProps" />