...
**Tags** may be removed by clicking their <span className="bp5-icon-standard bp5-icon-cross"></span> buttons or by pressing
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Handling long words</h5>
...
<div className="bp5-callout bp5-intent-primary bp5-icon-info-sign bp5-callout-has-body-content">
    <h5 className="bp5-heading">Disabling a tag input</h5>
...
<InterfaceTable name="TagInputProps" />