...
export const COMPOUND_TAG_KEY = `${COMPOUND_TAG}-key`;
export const COMPOUND_TAG_VALUE = `${COMPOUND_TAG}-value`;
export const COMPOUND_TAG_VALUE_TEXT = `${COMPOUND_TAG}-value-text`;
