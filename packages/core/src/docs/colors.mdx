...
<ReactDocs name="BlackWhitePalette" />
<ReactDocs name="GrayscalePalette" />
## Core colors
...
<ReactDocs name="CoreColorsPalette" />
## Extended colors
...
<ReactDocs name="ExtendedColorsPalette" />
## Usage
...
<ReactDocs name="QualitativeSchemePalette" />