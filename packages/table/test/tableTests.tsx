...
describe("<Table>", function (this) {
    ...
    describe("Freezing", () => {
        ...
        it("does not render frozen bleed cells if numFrozenRows=0 and numFrozenColumns=0", () => {
            ...
            expect(table.find(`.${Classes.TABLE_QUADRANT_TOP} .${Classes.TABLE_CELL}`)).to.have.lengthOf(0);
            expect(table.find(`.${Classes.TABLE_QUADRANT_LEFT} .${Classes.TABLE_CELL}`)).to.have.lengthOf(0);
            expect(table.find(`.${Classes.TABLE_QUADRANT_TOP_LEFT} .${Classes.TABLE_CELL}`)).to.have.lengthOf(0);
        });
