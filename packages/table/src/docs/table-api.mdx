...
<InterfaceTable name="TableProps" />
### Instance methods

<MethodTable name="Table.resizeRowsByTallestCell" />
<MethodTable name="Table.resizeRowsByApproximateHeight" />
...
<MethodTable name="Table.scrollToRegion" />
<MethodTable name="Table.scrollByOffset" />
## Column
...
<InterfaceTable name="ColumnProps" />
## Cell
...
<InterfaceTable name="EditableCellProps" />
## RowHeaderCell
...
<InterfaceTable name="RowHeaderCellProps" />
## Region
...
<MethodTable name="Regions.getRegionCardinality" />
## TruncatedFormat
...
<InterfaceTable name="TruncatedFormatProps" />
## JSONFormat
...
<InterfaceTable name="JSONFormatProps" />