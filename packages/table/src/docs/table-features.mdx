...
<div className="bp5-callout bp5-large bp5-intent-primary bp5-icon-info-sign">

This example utilizes `cellRendererDependencies`; [see why in the section below](#table/features.re-rendering-cells).

</div>

<ReactExample name="TableSortableExample" />
## Re-rendering cells
...
<ReactExample name="TableEditableExample" />
## Reordering
...
<ReactExample name="TableReorderableExample" />
## Loading states
...
<ReactExample name="TableLoadingExample" />
...
<ReactExample name="ColumnLoadingExample" />
### Cells
...
<ReactExample name="CellLoadingExample" />
## Formatting
...
<ReactExample name="TableFormatsExample" />
## Freezing
...
<ReactExample name="TableFreezingExample" />