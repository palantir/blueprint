...
import { AbstractPureComponentNewLifecycles, IProps } from "@blueprintjs/core";
...
export class RowHeaderCell extends AbstractPureComponentNewLifecycles<IRowHeaderCellProps, {}> {
    public render() {
        const {
