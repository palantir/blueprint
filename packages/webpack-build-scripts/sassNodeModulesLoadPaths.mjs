...
/**
 * @fileoverview HACKHACK: copied source from node-build-scripts
 */
...
if (packageJsonPath === undefined) {
    throw new Error(
        `[webpack-build-scripts] Unable to generate Sass loadPaths, make sure there is a package.json file and node_modules directory`,
    );
}
