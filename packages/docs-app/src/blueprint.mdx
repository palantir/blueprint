...
<ReactDocs name="Welcome" />
<div className="bp5-callout bp5-intent-primary bp5-icon-star bp5-callout-has-body-content">
    <h5 className="bp5-heading">Blueprint v6.x is now available</h5>
