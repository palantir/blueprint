...
import { BlackWhitePalette, GrayscalePalette, CoreColorsPalette, ExtendedColorsPalette } from "./examples/colorPalettes";
import { SequentialSchemePalette, DivergingSchemePalette, QualitativeSchemePalette } from "./examples/colorSchemes";
