...
<Interface name="IColumnHeaderCellProps" />
...
<Interface name="IEditableNameProps" />
...
<Interface name="IEditableCellProps" />
...
<Interface name="ITruncatedFormatProps" />
...
<Interface name="IJSONFormatProps" />
