...
import { ButtonGroupExample } from "../examples/core-examples/buttonGroupExample";
import { ButtonGroupPopoverExample } from "../examples/core-examples/buttonGroupPopoverExample";
...
<Interface name="IButtonGroupProps" />
