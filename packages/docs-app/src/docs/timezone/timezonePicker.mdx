...
route: /timezone/components/timezonePicker
---

import { Callout } from "@blueprintjs/core";
import { Interface } from "@blueprintjs/docz-theme";
import { TimezonePickerExample } from "./examples/timezonePickerExample";
...
<Callout intent="warning" title="Local timezone detection">
...
<Interface name="ITimezonePickerProps" />
