---
menu: Core
route: /core/components/nonIdealState
---

import { CssExample, Interface } from "@blueprintjs/docz-theme";
import { NonIdealStateExample } from "./examples/nonIdealStateExample";
...
<Interface name="INonIdealStateProps" />
...
<CssExample name="non-ideal-state" />
