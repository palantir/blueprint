---
menu: Core
route: /core/components/numericInput
---

import { CssExample, Interface } from "@blueprintjs/docz-theme";
import { NumericInputBasicExample } from "./examples/numericInputBasicExample";
import { NumericInputExtendedExample } from "./examples/numericInputExtendedExample";
...
<Interface name="INumericInputProps" />
