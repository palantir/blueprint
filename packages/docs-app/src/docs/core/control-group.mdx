---
menu: Core
route: /core/components/controlGroup
---

import { Callout } from "@blueprintjs/core";
import { CssExample, Interface } from "@blueprintjs/docz-theme";
import { ControlGroupExample } from "./examples/controlGroupExample";
...
<Callout intent="success" title="Control group vs. input group">
...
<Interface name="IControlGroupProps" />
