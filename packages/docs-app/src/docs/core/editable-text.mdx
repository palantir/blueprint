---
menu: Core
route: /core/components/editableText
---

import { Callout } from "@blueprintjs/core";
import { CssExample, Interface } from "@blueprintjs/docz-theme";
import { EditableTextExample } from "./examples/editableTextExample";
...
<Callout intent="danger" title="Centering the component">
...
<Interface name="IEditableTextProps" />
