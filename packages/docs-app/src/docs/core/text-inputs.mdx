---
menu: Core
route: /core/components/textInputs
---
...
<Interface name="IInputGroupProps" />
...
<Callout intent="warning" title="Icons only">
...
<CssExample name="textarea" />

<Interface name="ITextAreaProps" />
