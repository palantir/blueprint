---
menu: Core
route: /core/components/panelStack
tag: new
---

import { Interface } from "@blueprintjs/docz-theme";
import { PanelStackExample } from "./examples/panelStackExample";
...
<Interface name="IPanel" />

<Interface name="IPanelProps" />
...
<Interface name="IPanelStackProps" />
