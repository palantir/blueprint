---
menu: Core
route: /core/components/collapsibleList
---

import { CssExample, Interface } from "@blueprintjs/docz-theme";
import { CollapsibleListExample } from "./examples/collapsibleListExample";
...
<Callout intent="danger" title="Deprecated: use [Overflow list](#core/components/overflow-list)">
...
<Interface name="ICollapsibleListProps" />
