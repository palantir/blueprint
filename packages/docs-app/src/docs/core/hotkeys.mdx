...
import { HotkeyPiano } from "./examples/hotkeyPiano";
import { HotkeyTester } from "./examples/hotkeyTester";
...
<Interface name="IHotkeysProps" />

<Interface name="IHotkeyProps" />
