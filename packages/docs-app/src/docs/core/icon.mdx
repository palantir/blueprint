...
<Callout intent="primary" title="SVG icons in 2.0">
...
<Interface name="IIconProps" />

## CSS

<Callout intent="warning" title="Icon fonts are legacy in 2.0">
...
<Callout intent="primary" title="Non-standard sizes">
