...
- Many new components! Look for the <Tag minimal={true} intent="success">new</Tag> tag in the sidebar.
- Complete refactor of documentation content to focus on React usage and de-emphasize CSS/HTML usage.

<Button intent="primary" href="https://github.com/palantir/blueprint/wiki/3.0-Changelog" target="_blank" style={{ marginTop: 30 }}>
