...
export default function ListogramShowBars() {
    return (
        <div className="group">
            <Listogram items={ITEMS} title="With bars (default)" showBars={true} />
            <Listogram items={ITEMS} title="Without bars" showBars={false} />
        </div>
    );
}
