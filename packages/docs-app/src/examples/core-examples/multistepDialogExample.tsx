...
import { Button, Code, H5, MultistepDialog, Step, IMultistepDialogPanelProps, Switch, Classes, ISubmitButtonProps } from "@blueprintjs/core";
...
export class MultistepDialogExample extends React.PureComponent<IExampleProps<IBlueprintExampleData>, IMultistepDialogExampleState> {
        ...
        return (
            <Example options={this.renderOptions()} {...this.props}>
                ...
                >
                    ...
                    <Step id={"s2"} renderPanel={this.renderPanel} title={"Step 2"} nextButtonEnabledByDefault={false}/>
                </MultistepDialog>
            </Example>
        );
    }
