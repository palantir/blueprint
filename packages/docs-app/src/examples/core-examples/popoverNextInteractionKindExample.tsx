...
import { Button, Intent, type PopoverInteractionKind, PopoverNext } from "@blueprintjs/core";
...
export const PopoverNextInteractionKindExample: React.FC<ExampleProps> = props => {
    return (
