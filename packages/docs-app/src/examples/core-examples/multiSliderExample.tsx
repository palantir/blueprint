                ...
                >
                    ...
                    {showDanger && (
                        <MultiSlider.Handle
                            ...
                            handleHtmlProps={{ "aria-label": "danger start" }}
                        />
                    )}
                    {showWarning && (
                        <MultiSlider.Handle
                            ...
                            interactionKind={interactionKind}
                            handleHtmlProps={{ "aria-label": "warning start" }}
                        />
                    )}
                    {showWarning && (
                        <MultiSlider.Handle
                            ...
                            intentAfter="warning"
                            interactionKind={interactionKind}
                            handleHtmlProps={{ "aria-label": "warning end" }}
                        />
                    )}
                    {showDanger && (
                        <MultiSlider.Handle
                            ...
                            intentAfter="danger"
                            interactionKind={interactionKind}
                            handleHtmlProps={{ "aria-label": "danger end" }}
                        />
                    )}
                </MultiSlider>
            </Example>
