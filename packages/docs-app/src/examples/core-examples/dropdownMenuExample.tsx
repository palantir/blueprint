...
const ExampleMenu: React.FC = () => (
    <Menu>
        ...
        <MenuItem icon={IconNames.TH} text="Table" shouldDismissPopover={false} />
        <MenuItem icon={IconNames.ZOOM_TO_FIT} text="Browser" disabled={true} />
        <MenuDivider />
        <MenuItem icon={IconNames.COG} text="Settings...">
            <MenuItem icon={IconNames.ADD} text="Add new application" disabled={true} />
