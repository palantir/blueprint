...
<h4 class="@ns-heading">This is an old major version of Blueprint</h4>

[Check out the migration guide to v4.0 here &rarr;](https://github.com/palantir/blueprint/wiki/Blueprint-4.0)
</div>
